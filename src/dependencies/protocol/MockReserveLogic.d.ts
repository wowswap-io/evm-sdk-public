...
interface MockReserveLogicInterface extends ethers.utils.Interface {
  functions: {
...
export class MockReserveLogic extends BaseContract {
  ...
  interface: MockReserveLogicInterface;
