...
interface UniswapV3LongPairInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapV3LongPair extends BaseContract {
  ...
  interface: UniswapV3LongPairInterface;
