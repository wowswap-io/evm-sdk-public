...
import type {
  AbstractLongPair,
  AbstractLongPairInterface,
} from "../AbstractLongPair";
...
export class AbstractLongPair__factory {
  static readonly abi = _abi;
  static createInterface(): AbstractLongPairInterface {
    return new utils.Interface(_abi) as AbstractLongPairInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AbstractLongPair {
    return new Contract(address, _abi, signerOrProvider) as AbstractLongPair;
  }
}
