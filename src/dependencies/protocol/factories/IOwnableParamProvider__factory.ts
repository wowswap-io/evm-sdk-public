...
import type {
  IOwnableParamProvider,
  IOwnableParamProviderInterface,
} from "../IOwnableParamProvider";
...
export class IOwnableParamProvider__factory {
  static readonly abi = _abi;
  static createInterface(): IOwnableParamProviderInterface {
    return new utils.Interface(_abi) as IOwnableParamProviderInterface;
  }
  static connect(
    address: string,
