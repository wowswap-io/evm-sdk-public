...
import type { IPairExplorer, IPairExplorerInterface } from "../IPairExplorer";
...
export class IPairExplorer__factory {
  static readonly abi = _abi;
  static createInterface(): IPairExplorerInterface {
    return new utils.Interface(_abi) as IPairExplorerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPairExplorer {
    return new Contract(address, _abi, signerOrProvider) as IPairExplorer;
  }
}
