...
import type { ILongPair, ILongPairInterface } from "../ILongPair";
...
export class ILongPair__factory {
  static readonly abi = _abi;
  static createInterface(): ILongPairInterface {
    return new utils.Interface(_abi) as ILongPairInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ILongPair {
    return new Contract(address, _abi, signerOrProvider) as ILongPair;
  }
}
