...
interface UniswapV2ShortingPairInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapV2ShortingPair extends BaseContract {
  ...
  interface: UniswapV2ShortingPairInterface;
