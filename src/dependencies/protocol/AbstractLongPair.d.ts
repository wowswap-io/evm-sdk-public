...
interface AbstractLongPairInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractLongPair extends BaseContract {
  ...
  interface: AbstractLongPairInterface;
