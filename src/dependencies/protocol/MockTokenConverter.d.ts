...
interface MockTokenConverterInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTokenConverter extends BaseContract {
  ...
  interface: MockTokenConverterInterface;
