...
interface ShortingPairDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class ShortingPairDeployer extends BaseContract {
  ...
  interface: ShortingPairDeployerInterface;
