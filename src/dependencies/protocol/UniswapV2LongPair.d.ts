...
interface UniswapV2LongPairInterface extends ethers.utils.Interface {
  functions: {
    ...
    "calcExpirationDate(address,uint256)": FunctionFragment;
    ...
    "openPosition(address,uint256,uint256,address,(uint256,uint256,uint256,uint256,(uint8,bytes32,bytes32)))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calcExpirationDate",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class UniswapV2LongPair extends BaseContract {
  ...
  interface: UniswapV2LongPairInterface;
