...
interface IMimoFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IMimoFactory extends BaseContract {
  ...
  interface: IMimoFactoryInterface;
  ...
  callStatic: {
    ...
    setReferral(arg0: string, overrides?: CallOverrides): Promise<void>;
  };
