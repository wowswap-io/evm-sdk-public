...
interface UniswapV3ShortingPairInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapV3ShortingPair extends BaseContract {
  ...
  interface: UniswapV3ShortingPairInterface;
