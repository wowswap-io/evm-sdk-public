...
interface MimoV2ShortingPairInterface extends ethers.utils.Interface {
  functions: {
...
export class MimoV2ShortingPair extends BaseContract {
  ...
  interface: MimoV2ShortingPairInterface;
