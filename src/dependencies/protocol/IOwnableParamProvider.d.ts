...
interface IOwnableParamProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class IOwnableParamProvider extends BaseContract {
  ...
  interface: IOwnableParamProviderInterface;
