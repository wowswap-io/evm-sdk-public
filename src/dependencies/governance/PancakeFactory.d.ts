...
export class PancakeFactory extends BaseContract {
  ...
  functions: {
    ...
    pairHashcode(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    pairHashcode(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    pairHashcode(overrides?: CallOverrides): Promise<PopulatedTransaction>;
