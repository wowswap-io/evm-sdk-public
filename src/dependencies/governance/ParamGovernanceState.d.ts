...
interface ParamGovernanceStateInterface extends ethers.utils.Interface {
  functions: {
...
export class ParamGovernanceState extends BaseContract {
  ...
  interface: ParamGovernanceStateInterface;
